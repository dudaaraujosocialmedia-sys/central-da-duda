export const IDEIAS_BASE = {
  ...
  'Odontologia': [
    ...
    'Carrossel: aparelho fixo x alinhadores transparentes — compare preco, tempo, conforto e indicacoes.',
    ...
    'Post humanizado: o quanto um sorriso saudavel impacta na autoestima e na confianca no dia a dia.',
  ],
  'Psicologia': [
    ...
    'Reels: por que a terapia nao e so para quem esta em crise — o que voce ganha ao comecar antes do limite.',
    'Post humanizado: o que eu aprendo com meus pacientes todos os dias — compartilhe um insight da clinica com cuidado.',
  ],
  'Educacao Fisica': [
    'Reels: os 3 erros mais comuns no agachamento — mostra feito certo e errado de forma rapida e didatica.',
    ...
    'Carrossel: mitos do mundo da musculacao — "musculo vira gordura", "mulher que treina fica masculina". Desmistifica.',
    'Post: dor muscular no dia seguinte (DOMS) — o que e, por que acontece e quando e sinal de que voce exagerou.',
    'Reels: alongamento pos-treino — rotina de 5 minutos que todo mundo deveria fazer mas ninguem faz.',
  ...
  'Arquitetura': [
    ...
    'Reels: processo criativo de um projeto — do briefing ao croqui. Mostra os bastidores.',
    ...
    'Reels: a paleta de cores do projeto — mostre como voce escolheu as cores de um projeto real e por que.',
  ],
  'Contabilidade': [
    ...
    'Post: por que contratar um contador desde o inicio da empresa e investimento e nao custo.',
  ...
  'Moda': [
    ...
    'Carrossel: styling para cada tipo de silhueta — o que favorece retangular, ampulheta, triangulo e triangulo invertido.',
  ...
  'Beleza e Estetica': [
    ...
    'Carrossel: como identificar seu tipo de pele e montar a rotina certa para cada uma.',
  ...
  'Gastronomia': [
    ...
    'Carrossel: o que nao pode faltar em uma despensa bem organizada — lista pratica para cozinhar bem.',
  ...
  'Financas Pessoais': [
    ...
    'Post: financas e emocao — por que a relacao com dinheiro e psicologica e como trabalhar isso.',
  ],
  'Empreendedorismo': [
  ...
  'Veterinaria': [
    ...
    'Reels: "Meu gato comeu uva ou chocolate — e perigoso?" — responda de forma clara e educativa.',
    ...
    'Post: caso clinico anonimo — como voce diagnosticou algo que os tutores nao tinham percebido.',
  ],
  'Fotografia': [
    ...
    'Post: como funciona a luz natural — janela, horario, posicao e por que fotografia na hora dourada e diferente.',
    ...
    'Post: como eu crio consistencia visual no meu feed — tom de cor, luz, enquadramento.',
  ...
  'RH e Gestao de Pessoas': [
    ...
    'Post: o que e cultura organizacional de verdade — alem do "somos uma familia" e a "missao na parede".',
...
export const IDEIAS_GENERICAS = [
  ...
  'Carrossel: o que voce faz diferente dos outros profissionais da sua area — seu diferencial com exemplos.',
